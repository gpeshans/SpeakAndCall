...
public class RecognizerTaskNames implements Runnable {
	...
	public RecognitionListenerNames getRecognitionListener() {
		return rl;
	}

	public void setRecognitionListenerNames(RecognitionListenerNames rl) {
		this.rl = rl;
	}
	...
	public RecognizerTaskNames() {
		pocketsphinx
				.setLogfile(Environment.getExternalStorageDirectory().getPath()
						+ "/" + StartActivity.APP_NAME + "/pocketsphinx.log");
		Config c = new Config();
		/*
					...
					if (hyp != null) {
						...
						if (hypstr != partial_hyp) {
							...
							if (this.rl != null && hyp != null) {
								Bundle b = new Bundle();
								b.putString("hyp", hyp.getHypstr());
								this.rl.onPartialResultsNames(b);
							}
						}
						partial_hyp = hypstr;
					}
